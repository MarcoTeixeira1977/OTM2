...
def mutate_boundary(boundary_obj, boundary_dict):
    return boundary_obj
    # example code below is from philly
...
MIGRATION_RULES['tree']['common_fields'].add('id')
MIGRATION_RULES['tree']['common_fields'].add('tree_owner')
MIGRATION_RULES['tree']['common_fields'].add('steward_name')
MIGRATION_RULES['tree']['common_fields'].add('steward_user_id')
MIGRATION_RULES['tree']['common_fields'].add('sponsor')
MIGRATION_RULES['tree']['common_fields'].add('species_other1')
MIGRATION_RULES['tree']['common_fields'].add('species_other2')
MIGRATION_RULES['tree']['common_fields'].add('orig_species')
MIGRATION_RULES['tree']['common_fields'].add('dbh')
MIGRATION_RULES['tree']['common_fields'].add('present')
MIGRATION_RULES['tree']['common_fields'].add('last_updated')
MIGRATION_RULES['tree']['common_fields'].add('last_updated_by_id')
MIGRATION_RULES['tree']['common_fields'].add('s_order')
MIGRATION_RULES['tree']['common_fields'].add('photo_count')
MIGRATION_RULES['tree']['common_fields'].add('projects')
MIGRATION_RULES['tree']['common_fields'].add('import_event_id')
MIGRATION_RULES['tree']['common_fields'].add('condition')
MIGRATION_RULES['tree']['common_fields'].add('canopy_condition')
MIGRATION_RULES['tree']['common_fields'].add('url')
MIGRATION_RULES['tree']['common_fields'].add('pests')
