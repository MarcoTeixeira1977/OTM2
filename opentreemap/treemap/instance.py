...
DEFAULT_MOBILE_API_FIELDS = (
    {'header': ugettext_noop('Tree Information'),
     'model': 'tree',
     'field_keys': ['tree.data_owner',
                    'tree.species',
                    'tree.cot_tree_num',
                    'tree.diameter',
                    'tree.height',
                    'tree.canopy_height',
                    'tree.udf:Canopy Condition',
                    'tree.udf:Tree Condition',
                    'tree.date_planted',
                    'tree.date_removed',
                    'tree.udf:Projects',
                    ]},
