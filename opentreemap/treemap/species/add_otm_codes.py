...
conn = psycopg2.connect(dbname="otm_tampa", user="otm_user", password="fdbambh$UnN389y8")
conn2 = psycopg2.connect(dbname="otm_tampa", user="otm_user", password="fdbambh$UnN389y8")
cur = conn.cursor()
upcur = conn2.cursor()
